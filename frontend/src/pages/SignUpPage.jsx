			...
			<div className='min-h-screen bg-gradient-to-br from-indigo-200 via-purple-100 to-pink-200 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 flex items-center justify-center relative overflow-hidden'>
				...
				>
					<div className='p-10 bg-gradient-to-br from-purple-600 to-purple-800 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-900 rounded-t-3xl'>
						<h2 className='text-4xl font-extralight mb-8 text-center text-white'>
							Sign Up to <span className="text-teal-400">TestiFlow</span>
						</h2>
						...
						<form onSubmit={handleSignUp}>
							...
							<motion.button
								className='mt-6 w-full py-3 px-4 bg-gradient-to-r from-teal-500 to-teal-500  text-white font-semibold rounded-lg shadow-md hover:from-teal-600 hover:to-teal-600 focus:outline-none focus:ring-4 focus:ring-indigo-300 transition duration-200 ease-in-out'
					...
					<div className='px-10 py-4 bg-gray-50 dark:bg-gray-800 rounded-b-3xl flex justify-center'>
						<p className='text-sm text-gray-200 '>
							...
							<Link to={"/login"} className='text-teal-300 hover:underline'>Login here</Link>
						</p>
					</div>
				</motion.div>
			</div>
